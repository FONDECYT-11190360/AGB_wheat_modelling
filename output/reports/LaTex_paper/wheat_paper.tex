...
\author{Francisco Zambrano,
        Abel Herrera,
        and~Mauricio Molina-Roco%
\thanks{Manuscript submitted for review. This work was supported by the National Agency of Research and Development (ANID) of Chile through the grants FONDECYT Iniciación N°11190360, FONDEF IdEA I+D ID21I10297, and the drought emergency FSEQ210022.}%
\thanks{F.~Zambrano is with the Facultad de Economía, Negocios y Gobierno, Universidad San Sebastián, Santiago, Chile.}%
\thanks{A.~Herrera is with the Hemera Centro de Observación de la Tierra, Facultad de Ciencias, Ingeniería y Tecnología, Universidad Mayor, Santiago, Chile.}%
\thanks{M.~Molina-Roco is with the Laboratorio de Suelos y Sostenibilidad, Departamento de Acuicultura y Recursos Agroalimentarios, Universidad de Los Lagos, Osorno, 5311157, Chile.}}

\markboth{IEEE Geoscience and Remote Sensing Letters}%
{Zambrano \MakeLowercase{\textit{et al.}}: Multi-Sensor Wheat AGB Estimation Under LOSO Validation}
...
advanced this field~\cite{ref4}. Concurrently, Sentinel-1~(S1) SAR (Synthetic Aperture Radar) offers
...
comprising four distinct site-seasons used as LOSO folds (Fig.~\ref{fig:studyarea}). Field campaigns
...
\begin{figure}[!t]
\centering
\includegraphics[width=0.95\linewidth]{figs/area_estudio_v2.png}
\caption{The map on the left panel shows the location of the sites in Central Chile. The remaining panels illustrate the field boundaries and sampling points for each site. In Hidalgo, the northern field is from the 2021–2022 season, and the southern one from 2022–2023.
.}
\label{fig:studyarea}
\end{figure}
...
\begin{figure}[!t]
\centering
\includegraphics[width=0.95\linewidth]{figs/loso_ablation_metrics.png}
...
Applying Eq.~(\ref{eq:delta}) to the XGBoost results: S2 improves over the
...
\includegraphics[width=0.95\linewidth]{figs/interaccion_gdd_ps_evi.png}
...
modulates the thermal-time--biomass relationship. }
\label{fig:pdp}
\end{figure}
...
This work was supported by the National Agency of Research and Development (ANID) of Chile through the grants FONDECYT Iniciación N°11190360, FONDEF IdEA I+D ID21I10297, and the drought emergency FSEQ210022. Satellite imagery was accessed through the Microsoft Planetary Computer and Planet Labs Education and Research Program.
...
\bibitem{ref6}
C.~Xu, Y.~Ding, X.~Zheng, Y.~Qu, Z.~Tao, H.~Li, and Q.~Xie,
``Enhanced estimation of crop biomass and height using {Sentinel-1}
polarization texture indices and integration with optical remote sensing,''
\textit{Int. J. Digit. Earth}, vol.~19, no.~1, 2026, Art. no. 2616988.
doi:~10.1080/17538947.2026.2616988.

\bibitem{ref7}
R.~Houborg and M.~F.~McCabe,
``A {CubeSat} enabled spatio-temporal enhancement method ({CESTEM})
utilizing {Planet}, {Landsat} and {MODIS} data,''
\textit{Remote Sens. Environ.}, vol.~209, pp.~211--226, 2018.
doi:~10.1016/j.rse.2018.02.067.

\bibitem{ref8}
C.~Kumar, G.~Walton, P.~Santi, and C.~Luza,
``Random cross-validation produces biased assessment of machine learning
performance in regional landslide susceptibility prediction,''
\textit{Remote Sens.}, vol.~17, no.~2, Art. no. 213, 2025.
...
\bibitem{ref10}
L.~A.~Yates, Z.~Aandahl, S.~A.~Richards, and B.~W.~Brook,
``Cross validation for model selection: A review with examples from
ecology,''
\textit{Ecol. Monogr.}, vol.~93, no.~1, 2023, Art. no. e1557.
...
\bibitem{ref12}
E.~Ghafari, J.~P.~Walker, N.~N.~Das, K.~Davary, A.~Faridhosseini,
X.~Wu, and L.~Zhu,
``On the impact of {C}-band in place of {L}-band radar for {SMAP}
downscaling,''
\textit{Remote Sens. Environ.}, vol.~251, Art. no. 112111, 2020.
doi:~10.1016/j.rse.2020.112111.

\bibitem{ref13}
A.~Veloso, S.~Mermoz, A.~Bouvet, T.~Le~Toan, M.~Planells,
J.-F.~Dejoux, and E.~Ceschia,
``Understanding the temporal behavior of crops using {Sentinel-1} and
{Sentinel-2}-like data for agricultural applications,''
\textit{Remote Sens. Environ.}, vol.~199, pp.~415--426, 2017.
