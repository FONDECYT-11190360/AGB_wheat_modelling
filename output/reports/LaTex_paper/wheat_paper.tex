...
XGBoost baseline (RMSE~=~7.63~t/ha).}
\label{fig:ablation}
\end{figure}
...
This work was supported by FONDECYT Iniciación Grant 11190360 from the National Agency of Research and Development (ANID) of Chile. Satellite imagery
was accessed through the Microsoft Planetary Computer and Planet Labs Education and Research Program.
