...
sit_tile <- c('hidango' = '18HYH','la_cancha' = '19HBC','villa_baviera' = '19HBV')
date_range <- list('hidango'= as.Date(c('2021-05-01','2022-01-31')),
...
map(1:3,function(i){
  safely(f(i,sit_tile = sit_tile, date_range = date_range,dir_out = dir_out))
  })
